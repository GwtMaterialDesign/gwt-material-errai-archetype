...
### Includes
- gwt-material 2.0-rc6
- gwt-material-addins 2.0-rc6
- gwt-material-themes 2.0-rc6
- gwt-material-jquery - 2.0-rc6
- gwt-material-table - 2.0-rc6
- errai - 4.0.0.Beta4
...
3. Create a new project by running the following command in a folder of your choice: <code>mvn archetype:generate -DarchetypeGroupId=com.github.gwtmaterialdesign -DarchetypeArtifactId=gwt-material-errai-archetype -DarchetypeVersion=2.0-rc6</code>
